                ...
                <s:form method="post">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-xs-4 col-xs-offset-4 " style="margin: 0 37%;">
                            ...
                            <input type="button" value="登陆" class="btn btn-sm btn-info" id="login-button"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 link">
                            <p class="text-center remove-margin"><small>还没注册?</small> <a href="jsp/register.jsp" ><small>注册</small></a>
                            </p>
                        </div>
                    </div>
                 </s:form>
