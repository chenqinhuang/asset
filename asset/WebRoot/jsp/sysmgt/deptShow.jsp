    ...
    <div class="container-fluid">
        <div class="row ">
            ...
            <div class="col-xs-10">
                ...
                <br/><br/>
                <table class="table table-bordered table-striped text-center bg-info" id="depttable">
                    <thead >
                    <tr class="info">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <ul>
                                            <li>
                                                <label><span>部门Id:</span></label>
                                                <input type="text" id="deptId" value="" disabled="disabled"/>
                                            </li>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm updateDept" data-dismiss="modal">保存</button>
                                    </div>
                                </div>
                            </div>
                        </div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<ul>
									...
									<li><label><span>部门名称:</span></label> <input
										type="text" id="deptName2" value="" /></li>
							...
							<div class="modal-footer">
								<i>
									...
									<button type="button"
										class="btn btn-primary btn-sm addDept"
...
<script src="<%=request.getContextPath() %>/js/sysmgt/deptmanagement.js"></script>
<script>
