					...
					<table
						...
						<thead>
							<tr class="info">
								...
								<th class="text-center">经办人Id</th>
								<th class="text-center">采购部门Id</th>
								<th class="text-center">采购日期</th>
								<th class="text-center">采购用途</th>
...
<script src="<%=request.getContextPath() %>/js/asset/purchaseOrder.js"></script>
